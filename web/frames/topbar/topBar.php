...
<img src="<? echo URL_IMAGE_FOLDER."/pcg.gif"; ?>" border="0" alt="Back to PCG Home">
</a>
</td>
<td valign=top>
 <b><a href="<? echo PAGE_SOURCEFORGE_PROJECT_HOMEPAGE_URL; ?>" target="mainWindow"><? echo strtoupper(APPLICATION_NAME); ?> v<? echo APPLICATION_VERSION; ?></a></b>
 <br>(<a href="<? echo PAGE_AUTHOR_BIO; ?>" target="mainWindow"><font color=red><? echo LANG_BASIC_BY; ?><b> Nilesh Dosooye</b></font></a>)
</td>
</tr>
</table>
