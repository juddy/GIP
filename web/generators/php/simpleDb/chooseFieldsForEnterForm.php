...
if ($generateWhatForm=="enter") { $scriptToGo = PAGE_GENERATOR_PHP_SIMPLE_ENTER_FORM; }
else if ($generateWhatForm=="edit") { $scriptToGo = PAGE_GENERATOR_PHP_SIMPLE_ENTER_FORM; }
