...
?>
<?
$sqlQuery = "SELECT *  FROM CMS_OFFLINE_PROPERTIES WHERE PROPERTY_ID like '%$thisKeyword%'  OR PROPERTYDEF_ID like '%$thisKeyword%'  OR PROPERTY_MAPPING_ID like '%$thisKeyword%'  OR PROPERTY_MAPPING_TYPE like '%$thisKeyword%'  OR PROPERTY_VALUE like '%$thisKeyword%' ";
