...
?>
<h2>Enter CMS_ONLINE_PROPERTYDEF</h2>
<form name="cms_online_propertydefEnterForm" method="POST" action="insertNewCms_online_propertydef.php">
...
<input type="submit" name="submitEnterCMS_ONLINE_PROPERTYDEFForm" value="Enter CMS_ONLINE_PROPERTYDEF">
