...
?>
<?
$sql = "UPDATE CMS_ONLINE_PROPERTIES SET PROPERTY_ID = '$thisPROPERTY_ID' , PROPERTYDEF_ID = '$thisPROPERTYDEF_ID' , PROPERTY_MAPPING_ID = '$thisPROPERTY_MAPPING_ID' , PROPERTY_MAPPING_TYPE = '$thisPROPERTY_MAPPING_TYPE' , PROPERTY_VALUE = '$thisPROPERTY_VALUE'  WHERE PROPERTY_ID = '$thisPROPERTY_ID'";
...
<br><br><a href="listCMS_ONLINE_PROPERTIES.php">Go Back to List All Records</a>
