...
<form name="cms_online_accesscontrolEnterForm" method="POST" action="deleteCMS_ONLINE_ACCESSCONTROL.php">
<input type="hidden" name="thisRESOURCE_IDField" value="<? echo $thisRESOURCE_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_ONLINE_ACCESSCONTROLForm" value="Delete  from CMS_ONLINE_ACCESSCONTROL">
