...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE CMS_ONLINE_ACCESSCONTROL SET RESOURCE_ID = '$thisRESOURCE_ID' , PRINCIPAL_ID = '$thisPRINCIPAL_ID' , ACCESS_ALLOWED = '$thisACCESS_ALLOWED' , ACCESS_DENIED = '$thisACCESS_DENIED' , ACCESS_FLAGS = '$thisACCESS_FLAGS'  WHERE RESOURCE_ID = '$thisRESOURCE_ID'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO CMS_ONLINE_ACCESSCONTROL (RESOURCE_ID , PRINCIPAL_ID , ACCESS_ALLOWED , ACCESS_DENIED , ACCESS_FLAGS ) VALUES ('$thisRESOURCE_ID' , '$thisPRINCIPAL_ID' , '$thisACCESS_ALLOWED' , '$thisACCESS_DENIED' , '$thisACCESS_FLAGS' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM CMS_ONLINE_ACCESSCONTROL WHERE RESOURCE_ID = '$thisRESOURCE_ID'";
