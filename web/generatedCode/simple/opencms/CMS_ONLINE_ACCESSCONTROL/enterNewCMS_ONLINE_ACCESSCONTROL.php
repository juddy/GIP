...
?>
<h2>Enter CMS_ONLINE_ACCESSCONTROL</h2>
<form name="cms_online_accesscontrolEnterForm" method="POST" action="insertNewCms_online_accesscontrol.php">
...
<input type="submit" name="submitEnterCMS_ONLINE_ACCESSCONTROLForm" value="Enter CMS_ONLINE_ACCESSCONTROL">
