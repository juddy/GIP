...
?>
<?php
$sql = "SELECT   * FROM CMS_OFFLINE_PROPERTYDEF WHERE PROPERTYDEF_ID = '$thisPROPERTYDEF_ID'";
...
<h2>Update CMS_OFFLINE_PROPERTYDEF</h2>
<form name="cms_offline_propertydefUpdateForm" method="POST" action="updateCms_offline_propertydef.php">
...
<input type="submit" name="submitUpdateCMS_OFFLINE_PROPERTYDEFForm" value="Update CMS_OFFLINE_PROPERTYDEF">
