...
<h2>Update CMS_HISTORY_PROPERTYDEF</h2>
<form name="cms_history_propertydefUpdateForm" method="POST" action="updateCms_history_propertydef.php">
...
<input type="submit" name="submitUpdateCMS_HISTORY_PROPERTYDEFForm" value="Update CMS_HISTORY_PROPERTYDEF">
