...
?>
<?
$sqlQuery = "SELECT *  FROM CMS_OFFLINE_RESOURCE_RELATIONS WHERE RELATION_SOURCE_ID like '%$thisKeyword%'  OR RELATION_SOURCE_PATH like '%$thisKeyword%'  OR RELATION_TARGET_ID like '%$thisKeyword%'  OR RELATION_TARGET_PATH like '%$thisKeyword%'  OR RELATION_TYPE like '%$thisKeyword%' ";
