...
<form name="cms_online_urlname_mappingsEnterForm" method="POST" action="deleteCMS_ONLINE_URLNAME_MAPPINGS.php">
<input type="hidden" name="thisNAMEField" value="<? echo $thisNAME; ?>">
<input type="submit" name="submitConfirmDeleteCMS_ONLINE_URLNAME_MAPPINGSForm" value="Delete  from CMS_ONLINE_URLNAME_MAPPINGS">
