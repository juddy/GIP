...
?>
<?php
$sql = "SELECT   * FROM CMS_ONLINE_URLNAME_MAPPINGS WHERE NAME = '$thisNAME'";
...
<h2>Update CMS_ONLINE_URLNAME_MAPPINGS</h2>
<form name="cms_online_urlname_mappingsUpdateForm" method="POST" action="updateCms_online_urlname_mappings.php">
...
<input type="submit" name="submitUpdateCMS_ONLINE_URLNAME_MAPPINGSForm" value="Update CMS_ONLINE_URLNAME_MAPPINGS">
