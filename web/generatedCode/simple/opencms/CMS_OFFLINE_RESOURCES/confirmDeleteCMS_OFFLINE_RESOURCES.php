...
<form name="cms_offline_resourcesEnterForm" method="POST" action="deleteCMS_OFFLINE_RESOURCES.php">
<input type="hidden" name="thisRESOURCE_IDField" value="<? echo $thisRESOURCE_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_OFFLINE_RESOURCESForm" value="Delete  from CMS_OFFLINE_RESOURCES">
