...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO CMS_OFFLINE_RESOURCES (RESOURCE_ID , RESOURCE_TYPE , RESOURCE_FLAGS , RESOURCE_STATE , RESOURCE_SIZE , DATE_CONTENT , SIBLING_COUNT , DATE_CREATED , DATE_LASTMODIFIED , USER_CREATED , USER_LASTMODIFIED , PROJECT_LASTMODIFIED , RESOURCE_VERSION ) VALUES ('$thisRESOURCE_ID' , '$thisRESOURCE_TYPE' , '$thisRESOURCE_FLAGS' , '$thisRESOURCE_STATE' , '$thisRESOURCE_SIZE' , '$thisDATE_CONTENT' , '$thisSIBLING_COUNT' , '$thisDATE_CREATED' , '$thisDATE_LASTMODIFIED' , '$thisUSER_CREATED' , '$thisUSER_LASTMODIFIED' , '$thisPROJECT_LASTMODIFIED' , '$thisRESOURCE_VERSION' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM CMS_OFFLINE_RESOURCES WHERE RESOURCE_ID = '$thisRESOURCE_ID'";
...
$sql = "SELECT   * FROM CMS_OFFLINE_RESOURCES".$orderByQuery.$limitQuery;
