...
?>
<?php
$sql = "SELECT   * FROM CMS_OFFLINE_RESOURCES WHERE RESOURCE_ID = '$thisRESOURCE_ID'";
...
<h2>Update CMS_OFFLINE_RESOURCES</h2>
<form name="cms_offline_resourcesUpdateForm" method="POST" action="updateCms_offline_resources.php">
...
<input type="submit" name="submitUpdateCMS_OFFLINE_RESOURCESForm" value="Update CMS_OFFLINE_RESOURCES">
