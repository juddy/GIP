...
<form name="cms_projectsEnterForm" method="POST" action="deleteCMS_PROJECTS.php">
<input type="hidden" name="thisPROJECT_IDField" value="<? echo $thisPROJECT_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_PROJECTSForm" value="Delete  from CMS_PROJECTS">
