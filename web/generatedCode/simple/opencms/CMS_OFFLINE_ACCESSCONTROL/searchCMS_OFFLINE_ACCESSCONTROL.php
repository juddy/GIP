...
?>
<?
$sqlQuery = "SELECT *  FROM CMS_OFFLINE_ACCESSCONTROL WHERE RESOURCE_ID like '%$thisKeyword%'  OR PRINCIPAL_ID like '%$thisKeyword%'  OR ACCESS_ALLOWED like '%$thisKeyword%'  OR ACCESS_DENIED like '%$thisKeyword%'  OR ACCESS_FLAGS like '%$thisKeyword%' ";
...
?>
	...
	<TD><a href="editCMS_OFFLINE_ACCESSCONTROL.php?RESOURCE_IDField=<? echo $thisRESOURCE_ID; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteCMS_OFFLINE_ACCESSCONTROL.php?RESOURCE_IDField=<? echo $thisRESOURCE_ID; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
