...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE CMS_OFFLINE_URLNAME_MAPPINGS SET NAME = '$thisNAME' , STRUCTURE_ID = '$thisSTRUCTURE_ID' , STATE = '$thisSTATE' , DATE_CHANGED = '$thisDATE_CHANGED' , LOCALE = '$thisLOCALE'  WHERE NAME = '$thisNAME'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO CMS_OFFLINE_URLNAME_MAPPINGS (NAME , STRUCTURE_ID , STATE , DATE_CHANGED , LOCALE ) VALUES ('$thisNAME' , '$thisSTRUCTURE_ID' , '$thisSTATE' , '$thisDATE_CHANGED' , '$thisLOCALE' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM CMS_OFFLINE_URLNAME_MAPPINGS WHERE NAME = '$thisNAME'";
...
$sql = "SELECT   * FROM CMS_OFFLINE_URLNAME_MAPPINGS".$orderByQuery.$limitQuery;
