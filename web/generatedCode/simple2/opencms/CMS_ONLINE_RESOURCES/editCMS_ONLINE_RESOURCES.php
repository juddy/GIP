...
<h2>Update CMS_ONLINE_RESOURCES</h2>
<form name="cms_online_resourcesUpdateForm" method="POST" action="updateCms_online_resources.php">
...
<input type="submit" name="submitUpdateCMS_ONLINE_RESOURCESForm" value="Update CMS_ONLINE_RESOURCES">
