...
?>
<h2>Enter CMS_ONLINE_RESOURCES</h2>
<form name="cms_online_resourcesEnterForm" method="POST" action="insertNewCms_online_resources.php">
...
<input type="submit" name="submitEnterCMS_ONLINE_RESOURCESForm" value="Enter CMS_ONLINE_RESOURCES">
