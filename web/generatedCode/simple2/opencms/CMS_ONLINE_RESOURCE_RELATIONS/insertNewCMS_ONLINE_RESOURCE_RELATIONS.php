...
?>
<?
$sqlQuery = "INSERT INTO CMS_ONLINE_RESOURCE_RELATIONS (RELATION_SOURCE_ID , RELATION_SOURCE_PATH , RELATION_TARGET_ID , RELATION_TARGET_PATH , RELATION_TYPE ) VALUES ('$thisRELATION_SOURCE_ID' , '$thisRELATION_SOURCE_PATH' , '$thisRELATION_TARGET_ID' , '$thisRELATION_TARGET_PATH' , '$thisRELATION_TYPE' )";
