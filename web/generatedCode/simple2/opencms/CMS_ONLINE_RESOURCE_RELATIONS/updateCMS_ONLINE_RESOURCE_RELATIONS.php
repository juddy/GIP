...
?>
<?
$sql = "UPDATE CMS_ONLINE_RESOURCE_RELATIONS SET RELATION_SOURCE_ID = '$thisRELATION_SOURCE_ID' , RELATION_SOURCE_PATH = '$thisRELATION_SOURCE_PATH' , RELATION_TARGET_ID = '$thisRELATION_TARGET_ID' , RELATION_TARGET_PATH = '$thisRELATION_TARGET_PATH' , RELATION_TYPE = '$thisRELATION_TYPE'  WHERE RELATION_SOURCE_ID = '$thisRELATION_SOURCE_ID'";
...
<br><br><a href="listCMS_ONLINE_RESOURCE_RELATIONS.php">Go Back to List All Records</a>
