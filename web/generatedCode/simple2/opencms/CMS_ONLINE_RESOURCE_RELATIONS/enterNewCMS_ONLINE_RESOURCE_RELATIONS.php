...
?>
<h2>Enter CMS_ONLINE_RESOURCE_RELATIONS</h2>
<form name="cms_online_resource_relationsEnterForm" method="POST" action="insertNewCms_online_resource_relations.php">
...
<input type="submit" name="submitEnterCMS_ONLINE_RESOURCE_RELATIONSForm" value="Enter CMS_ONLINE_RESOURCE_RELATIONS">
