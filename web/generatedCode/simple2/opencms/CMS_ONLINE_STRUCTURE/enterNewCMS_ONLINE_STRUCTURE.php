...
?>
<h2>Enter CMS_ONLINE_STRUCTURE</h2>
<form name="cms_online_structureEnterForm" method="POST" action="insertNewCms_online_structure.php">
...
<input type="submit" name="submitEnterCMS_ONLINE_STRUCTUREForm" value="Enter CMS_ONLINE_STRUCTURE">
