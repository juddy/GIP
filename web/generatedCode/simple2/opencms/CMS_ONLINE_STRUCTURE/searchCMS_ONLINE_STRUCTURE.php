...
?>
	...
	<TD><a href="editCMS_ONLINE_STRUCTURE.php?STRUCTURE_IDField=<? echo $thisSTRUCTURE_ID; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteCMS_ONLINE_STRUCTURE.php?STRUCTURE_IDField=<? echo $thisSTRUCTURE_ID; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
