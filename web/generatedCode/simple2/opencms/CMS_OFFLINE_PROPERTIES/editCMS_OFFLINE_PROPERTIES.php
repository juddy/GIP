...
<h2>Update CMS_OFFLINE_PROPERTIES</h2>
<form name="cms_offline_propertiesUpdateForm" method="POST" action="updateCms_offline_properties.php">
...
<input type="submit" name="submitUpdateCMS_OFFLINE_PROPERTIESForm" value="Update CMS_OFFLINE_PROPERTIES">
