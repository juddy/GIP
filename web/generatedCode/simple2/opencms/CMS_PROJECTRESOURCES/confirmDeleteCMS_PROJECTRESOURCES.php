...
<form name="cms_projectresourcesEnterForm" method="POST" action="deleteCMS_PROJECTRESOURCES.php">
<input type="hidden" name="thisPROJECT_IDField" value="<? echo $thisPROJECT_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_PROJECTRESOURCESForm" value="Delete  from CMS_PROJECTRESOURCES">
