...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE CMS_USER_PUBLISH_LIST SET USER_ID = '$thisUSER_ID' , STRUCTURE_ID = '$thisSTRUCTURE_ID' , DATE_CHANGED = '$thisDATE_CHANGED'  WHERE USER_ID = '$thisUSER_ID'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO CMS_USER_PUBLISH_LIST (USER_ID , STRUCTURE_ID , DATE_CHANGED ) VALUES ('$thisUSER_ID' , '$thisSTRUCTURE_ID' , '$thisDATE_CHANGED' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM CMS_USER_PUBLISH_LIST WHERE USER_ID = '$thisUSER_ID'";
...
$sql = "SELECT   * FROM CMS_USER_PUBLISH_LIST".$orderByQuery.$limitQuery;
