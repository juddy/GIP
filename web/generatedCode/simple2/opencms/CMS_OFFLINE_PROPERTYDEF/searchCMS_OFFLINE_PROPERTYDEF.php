...
?>
<?
$sqlQuery = "SELECT *  FROM CMS_OFFLINE_PROPERTYDEF WHERE PROPERTYDEF_ID like '%$thisKeyword%'  OR PROPERTYDEF_NAME like '%$thisKeyword%'  OR PROPERTYDEF_TYPE like '%$thisKeyword%' ";
...
?>
	...
	<TD><a href="editCMS_OFFLINE_PROPERTYDEF.php?PROPERTYDEF_IDField=<? echo $thisPROPERTYDEF_ID; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteCMS_OFFLINE_PROPERTYDEF.php?PROPERTYDEF_IDField=<? echo $thisPROPERTYDEF_ID; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
