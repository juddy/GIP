...
?>
<h2>Enter CMS_OFFLINE_PROPERTYDEF</h2>
<form name="cms_offline_propertydefEnterForm" method="POST" action="insertNewCms_offline_propertydef.php">
...
<input type="submit" name="submitEnterCMS_OFFLINE_PROPERTYDEFForm" value="Enter CMS_OFFLINE_PROPERTYDEF">
