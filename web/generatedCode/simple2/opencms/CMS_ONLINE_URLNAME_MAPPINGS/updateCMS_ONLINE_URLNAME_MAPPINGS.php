...
?>
<?
$sql = "UPDATE CMS_ONLINE_URLNAME_MAPPINGS SET NAME = '$thisNAME' , STRUCTURE_ID = '$thisSTRUCTURE_ID' , STATE = '$thisSTATE' , DATE_CHANGED = '$thisDATE_CHANGED' , LOCALE = '$thisLOCALE'  WHERE NAME = '$thisNAME'";
...
<br><br><a href="listCMS_ONLINE_URLNAME_MAPPINGS.php">Go Back to List All Records</a>
