...
?>
<h2>Enter CMS_OFFLINE_RESOURCES</h2>
<form name="cms_offline_resourcesEnterForm" method="POST" action="insertNewCms_offline_resources.php">
...
<input type="submit" name="submitEnterCMS_OFFLINE_RESOURCESForm" value="Enter CMS_OFFLINE_RESOURCES">
