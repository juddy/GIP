...
?>
<?
$sql = "UPDATE CMS_OFFLINE_ACCESSCONTROL SET RESOURCE_ID = '$thisRESOURCE_ID' , PRINCIPAL_ID = '$thisPRINCIPAL_ID' , ACCESS_ALLOWED = '$thisACCESS_ALLOWED' , ACCESS_DENIED = '$thisACCESS_DENIED' , ACCESS_FLAGS = '$thisACCESS_FLAGS'  WHERE RESOURCE_ID = '$thisRESOURCE_ID'";
...
<br><br><a href="listCMS_OFFLINE_ACCESSCONTROL.php">Go Back to List All Records</a>
