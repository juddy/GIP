...
<h2>Update CMS_OFFLINE_ACCESSCONTROL</h2>
<form name="cms_offline_accesscontrolUpdateForm" method="POST" action="updateCms_offline_accesscontrol.php">
...
<input type="submit" name="submitUpdateCMS_OFFLINE_ACCESSCONTROLForm" value="Update CMS_OFFLINE_ACCESSCONTROL">
