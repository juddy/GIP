...
<form name="cms_publish_jobsEnterForm" method="POST" action="deleteCMS_PUBLISH_JOBS.php">
<input type="hidden" name="thisHISTORY_IDField" value="<? echo $thisHISTORY_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_PUBLISH_JOBSForm" value="Delete  from CMS_PUBLISH_JOBS">
