...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM CMS_HISTORY_PROJECTS WHERE PROJECT_ID = '$thisPROJECT_ID'";
...
<input type="hidden" name="thisPROJECT_IDField" value="<? echo $thisPROJECT_ID; ?>">
	<TR BGCOLOR="#FF6666">
		...
		<TD><input type"text" name="thisPROJECT_PUBLISHDATEField" value=""></TD>
		<TD><input type"text" name="thisPROJECT_PUBLISHED_BYField" value=""></TD>
...
<input type="hidden" name="thisPROJECT_IDField" value="<? echo $thisPROJECT_ID; ?>">
	<TR BGCOLOR="<? echo $bgColor; ?>">
		...
		<TD><input type"text" name="thisPROJECT_PUBLISHDATEField" value="<? echo $thisPROJECT_PUBLISHDATE; ?>"></TD>
		<TD><input type"text" name="thisPROJECT_PUBLISHED_BYField" value="<? echo $thisPROJECT_PUBLISHED_BY; ?>"></TD>
