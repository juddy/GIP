...
?>
<?
$sql = "UPDATE SCHEMA_PRIVILEGES SET GRANTEE = '$thisGRANTEE' , TABLE_CATALOG = '$thisTABLE_CATALOG' , TABLE_SCHEMA = '$thisTABLE_SCHEMA' , PRIVILEGE_TYPE = '$thisPRIVILEGE_TYPE' , IS_GRANTABLE = '$thisIS_GRANTABLE'  WHERE GRANTEE = '$thisGRANTEE'";
...
<br><br><a href="listSCHEMA_PRIVILEGES.php">Go Back to List All Records</a>
