...
<h2>Update SCHEMA_PRIVILEGES</h2>
<form name="schema_privilegesUpdateForm" method="POST" action="updateSchema_privileges.php">
...
<input type="submit" name="submitUpdateSCHEMA_PRIVILEGESForm" value="Update SCHEMA_PRIVILEGES">
