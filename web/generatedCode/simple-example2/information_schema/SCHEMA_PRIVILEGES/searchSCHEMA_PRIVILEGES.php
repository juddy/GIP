...
?>
<?
$sqlQuery = "SELECT *  FROM SCHEMA_PRIVILEGES WHERE GRANTEE like '%$thisKeyword%'  OR TABLE_CATALOG like '%$thisKeyword%'  OR TABLE_SCHEMA like '%$thisKeyword%'  OR PRIVILEGE_TYPE like '%$thisKeyword%'  OR IS_GRANTABLE like '%$thisKeyword%' ";
...
?>
	...
	<TD><a href="editSCHEMA_PRIVILEGES.php?GRANTEEField=<? echo $thisGRANTEE; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteSCHEMA_PRIVILEGES.php?GRANTEEField=<? echo $thisGRANTEE; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
