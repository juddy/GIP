...
?>
<h2>Enter INNODB_CMPMEM_RESET</h2>
<form name="innodb_cmpmem_resetEnterForm" method="POST" action="insertNewInnodb_cmpmem_reset.php">
...
<input type="submit" name="submitEnterINNODB_CMPMEM_RESETForm" value="Enter INNODB_CMPMEM_RESET">
