...
?>
<?
$sql = "UPDATE INNODB_CMPMEM_RESET SET page_size = '$thisPage_size' , buffer_pool_instance = '$thisBuffer_pool_instance' , pages_used = '$thisPages_used' , pages_free = '$thisPages_free' , relocation_ops = '$thisRelocation_ops' , relocation_time = '$thisRelocation_time'  WHERE page_size = '$thisPage_size'";
...
<br><br><a href="listINNODB_CMPMEM_RESET.php">Go Back to List All Records</a>
