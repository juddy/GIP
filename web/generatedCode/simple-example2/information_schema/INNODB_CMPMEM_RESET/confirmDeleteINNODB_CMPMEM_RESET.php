...
<form name="innodb_cmpmem_resetEnterForm" method="POST" action="deleteINNODB_CMPMEM_RESET.php">
<input type="hidden" name="thisPage_sizeField" value="<? echo $thisPage_size; ?>">
<input type="submit" name="submitConfirmDeleteINNODB_CMPMEM_RESETForm" value="Delete  from INNODB_CMPMEM_RESET">
