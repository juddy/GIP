...
<form name="global_variablesEnterForm" method="POST" action="deleteGLOBAL_VARIABLES.php">
<input type="hidden" name="thisVARIABLE_NAMEField" value="<? echo $thisVARIABLE_NAME; ?>">
<input type="submit" name="submitConfirmDeleteGLOBAL_VARIABLESForm" value="Delete  from GLOBAL_VARIABLES">
