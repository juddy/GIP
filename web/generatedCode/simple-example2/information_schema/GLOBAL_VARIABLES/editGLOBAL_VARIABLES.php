...
?>
<?php
$sql = "SELECT   * FROM GLOBAL_VARIABLES WHERE VARIABLE_NAME = '$thisVARIABLE_NAME'";
...
<h2>Update GLOBAL_VARIABLES</h2>
<form name="global_variablesUpdateForm" method="POST" action="updateGlobal_variables.php">
...
<input type="submit" name="submitUpdateGLOBAL_VARIABLESForm" value="Update GLOBAL_VARIABLES">
