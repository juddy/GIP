...
<form name="referential_constraintsEnterForm" method="POST" action="deleteREFERENTIAL_CONSTRAINTS.php">
<input type="hidden" name="thisCONSTRAINT_CATALOGField" value="<? echo $thisCONSTRAINT_CATALOG; ?>">
<input type="submit" name="submitConfirmDeleteREFERENTIAL_CONSTRAINTSForm" value="Delete  from REFERENTIAL_CONSTRAINTS">
