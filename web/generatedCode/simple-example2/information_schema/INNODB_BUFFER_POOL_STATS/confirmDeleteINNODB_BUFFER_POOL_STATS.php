...
<form name="innodb_buffer_pool_statsEnterForm" method="POST" action="deleteINNODB_BUFFER_POOL_STATS.php">
<input type="hidden" name="thisPOOL_IDField" value="<? echo $thisPOOL_ID; ?>">
<input type="submit" name="submitConfirmDeleteINNODB_BUFFER_POOL_STATSForm" value="Delete  from INNODB_BUFFER_POOL_STATS">
