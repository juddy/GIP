...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE USER_PRIVILEGES SET GRANTEE = '$thisGRANTEE' , TABLE_CATALOG = '$thisTABLE_CATALOG' , PRIVILEGE_TYPE = '$thisPRIVILEGE_TYPE' , IS_GRANTABLE = '$thisIS_GRANTABLE'  WHERE GRANTEE = '$thisGRANTEE'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO USER_PRIVILEGES (GRANTEE , TABLE_CATALOG , PRIVILEGE_TYPE , IS_GRANTABLE ) VALUES ('$thisGRANTEE' , '$thisTABLE_CATALOG' , '$thisPRIVILEGE_TYPE' , '$thisIS_GRANTABLE' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM USER_PRIVILEGES WHERE GRANTEE = '$thisGRANTEE'";
...
$sql = "SELECT   * FROM USER_PRIVILEGES".$orderByQuery.$limitQuery;
