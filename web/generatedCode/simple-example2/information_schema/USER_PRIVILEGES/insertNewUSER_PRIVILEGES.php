...
?>
<?
$sqlQuery = "INSERT INTO USER_PRIVILEGES (GRANTEE , TABLE_CATALOG , PRIVILEGE_TYPE , IS_GRANTABLE ) VALUES ('$thisGRANTEE' , '$thisTABLE_CATALOG' , '$thisPRIVILEGE_TYPE' , '$thisIS_GRANTABLE' )";
