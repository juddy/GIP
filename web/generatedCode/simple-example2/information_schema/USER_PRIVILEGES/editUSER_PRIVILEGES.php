...
<h2>Update USER_PRIVILEGES</h2>
<form name="user_privilegesUpdateForm" method="POST" action="updateUser_privileges.php">
...
<input type="submit" name="submitUpdateUSER_PRIVILEGESForm" value="Update USER_PRIVILEGES">
