...
?>
<?php
$sql = "SELECT   * FROM INNODB_CMP WHERE page_size = '$thisPage_size'";
...
<h2>Update INNODB_CMP</h2>
<form name="innodb_cmpUpdateForm" method="POST" action="updateInnodb_cmp.php">
...
<input type="submit" name="submitUpdateINNODB_CMPForm" value="Update INNODB_CMP">
