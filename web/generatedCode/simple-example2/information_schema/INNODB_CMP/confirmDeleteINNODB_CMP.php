...
<form name="innodb_cmpEnterForm" method="POST" action="deleteINNODB_CMP.php">
<input type="hidden" name="thisPage_sizeField" value="<? echo $thisPage_size; ?>">
<input type="submit" name="submitConfirmDeleteINNODB_CMPForm" value="Delete  from INNODB_CMP">
