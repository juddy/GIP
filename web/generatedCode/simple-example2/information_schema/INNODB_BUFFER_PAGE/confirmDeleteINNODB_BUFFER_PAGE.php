...
<form name="innodb_buffer_pageEnterForm" method="POST" action="deleteINNODB_BUFFER_PAGE.php">
<input type="hidden" name="thisPOOL_IDField" value="<? echo $thisPOOL_ID; ?>">
<input type="submit" name="submitConfirmDeleteINNODB_BUFFER_PAGEForm" value="Delete  from INNODB_BUFFER_PAGE">
