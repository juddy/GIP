...
<h2>Update INNODB_BUFFER_PAGE</h2>
<form name="innodb_buffer_pageUpdateForm" method="POST" action="updateInnodb_buffer_page.php">
...
<table cellspacing="2" cellpadding="2" border="0" width="100%">
	...
	<tr valign="top" height="20">
		...
		<td> <input type="text" name="thisBLOCK_IDField" size="20" value="<? echo $thisBLOCK_ID; ?>">  </td> 
	</tr>
	<tr valign="top" height="20">
	...
	<tr valign="top" height="20">
		...
		<td> <input type="text" name="thisPAGE_STATEField" size="20" value="<? echo $thisPAGE_STATE; ?>">  </td> 
	</tr>
	<tr valign="top" height="20">
...
<input type="submit" name="submitUpdateINNODB_BUFFER_PAGEForm" value="Update INNODB_BUFFER_PAGE">
