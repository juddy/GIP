...
?>
<?
$sqlQuery = "SELECT *  FROM GLOBAL_STATUS WHERE VARIABLE_NAME like '%$thisKeyword%'  OR VARIABLE_VALUE like '%$thisKeyword%' ";
...
?>
	...
	<TD><a href="editGLOBAL_STATUS.php?VARIABLE_NAMEField=<? echo $thisVARIABLE_NAME; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteGLOBAL_STATUS.php?VARIABLE_NAMEField=<? echo $thisVARIABLE_NAME; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
