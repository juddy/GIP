...
<h2>Update GLOBAL_STATUS</h2>
<form name="global_statusUpdateForm" method="POST" action="updateGlobal_status.php">
...
<input type="submit" name="submitUpdateGLOBAL_STATUSForm" value="Update GLOBAL_STATUS">
