...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE GLOBAL_STATUS SET VARIABLE_NAME = '$thisVARIABLE_NAME' , VARIABLE_VALUE = '$thisVARIABLE_VALUE'  WHERE VARIABLE_NAME = '$thisVARIABLE_NAME'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO GLOBAL_STATUS (VARIABLE_NAME , VARIABLE_VALUE ) VALUES ('$thisVARIABLE_NAME' , '$thisVARIABLE_VALUE' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM GLOBAL_STATUS WHERE VARIABLE_NAME = '$thisVARIABLE_NAME'";
...
$sql = "SELECT   * FROM GLOBAL_STATUS".$orderByQuery.$limitQuery;
