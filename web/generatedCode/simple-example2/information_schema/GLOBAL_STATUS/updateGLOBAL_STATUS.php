...
?>
<?
$sql = "UPDATE GLOBAL_STATUS SET VARIABLE_NAME = '$thisVARIABLE_NAME' , VARIABLE_VALUE = '$thisVARIABLE_VALUE'  WHERE VARIABLE_NAME = '$thisVARIABLE_NAME'";
...
<br><br><a href="listGLOBAL_STATUS.php">Go Back to List All Records</a>
