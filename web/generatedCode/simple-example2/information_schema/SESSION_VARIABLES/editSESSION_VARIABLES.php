...
<h2>Update SESSION_VARIABLES</h2>
<form name="session_variablesUpdateForm" method="POST" action="updateSession_variables.php">
...
<input type="submit" name="submitUpdateSESSION_VARIABLESForm" value="Update SESSION_VARIABLES">
