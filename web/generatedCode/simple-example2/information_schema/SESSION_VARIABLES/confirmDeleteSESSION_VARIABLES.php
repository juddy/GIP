...
<form name="session_variablesEnterForm" method="POST" action="deleteSESSION_VARIABLES.php">
<input type="hidden" name="thisVARIABLE_NAMEField" value="<? echo $thisVARIABLE_NAME; ?>">
<input type="submit" name="submitConfirmDeleteSESSION_VARIABLESForm" value="Delete  from SESSION_VARIABLES">
