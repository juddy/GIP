...
?>
<?
$sql = "UPDATE SESSION_VARIABLES SET VARIABLE_NAME = '$thisVARIABLE_NAME' , VARIABLE_VALUE = '$thisVARIABLE_VALUE'  WHERE VARIABLE_NAME = '$thisVARIABLE_NAME'";
...
<br><br><a href="listSESSION_VARIABLES.php">Go Back to List All Records</a>
