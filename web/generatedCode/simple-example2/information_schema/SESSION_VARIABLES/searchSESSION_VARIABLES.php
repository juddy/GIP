...
?>
<?
$sqlQuery = "SELECT *  FROM SESSION_VARIABLES WHERE VARIABLE_NAME like '%$thisKeyword%'  OR VARIABLE_VALUE like '%$thisKeyword%' ";
...
?>
	...
	<TD><a href="editSESSION_VARIABLES.php?VARIABLE_NAMEField=<? echo $thisVARIABLE_NAME; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteSESSION_VARIABLES.php?VARIABLE_NAMEField=<? echo $thisVARIABLE_NAME; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
