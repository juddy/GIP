...
$highlightColor = "#FFFF99"; 
	...
	$thisLRU_POSITION = highlightSearchTerms($thisLRU_POSITION, $thisKeyword, $highlightColor); 
	...
	$thisCOMPRESSED = highlightSearchTerms($thisCOMPRESSED, $thisKeyword, $highlightColor); 
...
?>
	...
	<TD><a href="editINNODB_BUFFER_PAGE_LRU.php?POOL_IDField=<? echo $thisPOOL_ID; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteINNODB_BUFFER_PAGE_LRU.php?POOL_IDField=<? echo $thisPOOL_ID; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
