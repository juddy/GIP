...
?>
<h2>Enter INNODB_BUFFER_PAGE_LRU</h2>
<form name="innodb_buffer_page_lruEnterForm" method="POST" action="insertNewInnodb_buffer_page_lru.php">
...
<table cellspacing="2" cellpadding="2" border="0" width="100%">
	...
	<tr valign="top" height="20">
		...
		<td> <input type="text" name="thisLRU_POSITIONField" size="20" value="">  </td> 
	</tr>
	<tr valign="top" height="20">
	...
	<tr valign="top" height="20">
		...
		<td> <input type="text" name="thisCOMPRESSEDField" size="20" value="">  </td> 
	</tr>
	<tr valign="top" height="20">
...
<input type="submit" name="submitEnterINNODB_BUFFER_PAGE_LRUForm" value="Enter INNODB_BUFFER_PAGE_LRU">
