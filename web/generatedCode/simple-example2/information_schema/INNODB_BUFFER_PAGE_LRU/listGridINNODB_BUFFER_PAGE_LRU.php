...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO INNODB_BUFFER_PAGE_LRU (POOL_ID , LRU_POSITION , SPACE , PAGE_NUMBER , PAGE_TYPE , FLUSH_TYPE , FIX_COUNT , IS_HASHED , NEWEST_MODIFICATION , OLDEST_MODIFICATION , ACCESS_TIME , TABLE_NAME , INDEX_NAME , NUMBER_RECORDS , DATA_SIZE , COMPRESSED_SIZE , COMPRESSED , IO_FIX , IS_OLD , FREE_PAGE_CLOCK ) VALUES ('$thisPOOL_ID' , '$thisLRU_POSITION' , '$thisSPACE' , '$thisPAGE_NUMBER' , '$thisPAGE_TYPE' , '$thisFLUSH_TYPE' , '$thisFIX_COUNT' , '$thisIS_HASHED' , '$thisNEWEST_MODIFICATION' , '$thisOLDEST_MODIFICATION' , '$thisACCESS_TIME' , '$thisTABLE_NAME' , '$thisINDEX_NAME' , '$thisNUMBER_RECORDS' , '$thisDATA_SIZE' , '$thisCOMPRESSED_SIZE' , '$thisCOMPRESSED' , '$thisIO_FIX' , '$thisIS_OLD' , '$thisFREE_PAGE_CLOCK' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM INNODB_BUFFER_PAGE_LRU WHERE POOL_ID = '$thisPOOL_ID'";
...
$sql = "SELECT   * FROM INNODB_BUFFER_PAGE_LRU".$orderByQuery.$limitQuery;
...
<TABLE CELLSPACING="0" CELLPADDING="3" BORDER="0" WIDTH="100%">
	<TR>
		...
		<TD>
			<a href="<? echo $PHP_SELF; ?>?sortBy=LRU_POSITION&sortOrder=<? echo $newSortOrder; ?>&startLimit=<? echo $startLimit; ?>&rows=<? echo $limitPerPage; ?>">
				<B>LRU_POSITION</B>
			</a>
</TD>
		<TD>
		...
		<TD>
			<a href="<? echo $PHP_SELF; ?>?sortBy=COMPRESSED&sortOrder=<? echo $newSortOrder; ?>&startLimit=<? echo $startLimit; ?>&rows=<? echo $limitPerPage; ?>">
				<B>COMPRESSED</B>
			</a>
</TD>
		<TD>
...
<input type="hidden" name="thisPOOL_IDField" value="<? echo $thisPOOL_ID; ?>">
	<TR BGCOLOR="#FF6666">
		...
		<TD><input type"text" name="thisLRU_POSITIONField" value=""></TD>
		...
		<TD><input type"text" name="thisCOMPRESSEDField" value=""></TD>
...
<input type="hidden" name="thisPOOL_IDField" value="<? echo $thisPOOL_ID; ?>">
	<TR BGCOLOR="<? echo $bgColor; ?>">
		...
		<TD><input type"text" name="thisLRU_POSITIONField" value="<? echo $thisLRU_POSITION; ?>"></TD>
		...
		<TD><input type"text" name="thisCOMPRESSEDField" value="<? echo $thisCOMPRESSED; ?>"></TD>
