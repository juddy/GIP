...
?>
<?
$sqlQuery = "SELECT *  FROM INNODB_CMPMEM WHERE page_size like '%$thisKeyword%'  OR buffer_pool_instance like '%$thisKeyword%'  OR pages_used like '%$thisKeyword%'  OR pages_free like '%$thisKeyword%'  OR relocation_ops like '%$thisKeyword%'  OR relocation_time like '%$thisKeyword%' ";
