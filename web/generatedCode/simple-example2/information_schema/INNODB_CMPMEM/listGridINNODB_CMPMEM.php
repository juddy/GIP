...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE INNODB_CMPMEM SET page_size = '$thisPage_size' , buffer_pool_instance = '$thisBuffer_pool_instance' , pages_used = '$thisPages_used' , pages_free = '$thisPages_free' , relocation_ops = '$thisRelocation_ops' , relocation_time = '$thisRelocation_time'  WHERE page_size = '$thisPage_size'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO INNODB_CMPMEM (page_size , buffer_pool_instance , pages_used , pages_free , relocation_ops , relocation_time ) VALUES ('$thisPage_size' , '$thisBuffer_pool_instance' , '$thisPages_used' , '$thisPages_free' , '$thisRelocation_ops' , '$thisRelocation_time' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM INNODB_CMPMEM WHERE page_size = '$thisPage_size'";
