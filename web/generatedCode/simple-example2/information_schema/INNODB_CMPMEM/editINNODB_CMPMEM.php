...
<h2>Update INNODB_CMPMEM</h2>
<form name="innodb_cmpmemUpdateForm" method="POST" action="updateInnodb_cmpmem.php">
...
<input type="submit" name="submitUpdateINNODB_CMPMEMForm" value="Update INNODB_CMPMEM">
