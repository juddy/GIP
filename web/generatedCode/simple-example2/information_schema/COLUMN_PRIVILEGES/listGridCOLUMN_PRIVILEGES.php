...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE COLUMN_PRIVILEGES SET GRANTEE = '$thisGRANTEE' , TABLE_CATALOG = '$thisTABLE_CATALOG' , TABLE_SCHEMA = '$thisTABLE_SCHEMA' , TABLE_NAME = '$thisTABLE_NAME' , COLUMN_NAME = '$thisCOLUMN_NAME' , PRIVILEGE_TYPE = '$thisPRIVILEGE_TYPE' , IS_GRANTABLE = '$thisIS_GRANTABLE'  WHERE GRANTEE = '$thisGRANTEE'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO COLUMN_PRIVILEGES (GRANTEE , TABLE_CATALOG , TABLE_SCHEMA , TABLE_NAME , COLUMN_NAME , PRIVILEGE_TYPE , IS_GRANTABLE ) VALUES ('$thisGRANTEE' , '$thisTABLE_CATALOG' , '$thisTABLE_SCHEMA' , '$thisTABLE_NAME' , '$thisCOLUMN_NAME' , '$thisPRIVILEGE_TYPE' , '$thisIS_GRANTABLE' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM COLUMN_PRIVILEGES WHERE GRANTEE = '$thisGRANTEE'";
...
$sql = "SELECT   * FROM COLUMN_PRIVILEGES".$orderByQuery.$limitQuery;
