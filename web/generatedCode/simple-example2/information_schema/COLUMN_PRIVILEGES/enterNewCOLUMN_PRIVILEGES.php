...
?>
<h2>Enter COLUMN_PRIVILEGES</h2>
<form name="column_privilegesEnterForm" method="POST" action="insertNewColumn_privileges.php">
...
<input type="submit" name="submitEnterCOLUMN_PRIVILEGESForm" value="Enter COLUMN_PRIVILEGES">
