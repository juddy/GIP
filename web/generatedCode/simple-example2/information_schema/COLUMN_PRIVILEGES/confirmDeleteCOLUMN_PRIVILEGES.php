...
<form name="column_privilegesEnterForm" method="POST" action="deleteCOLUMN_PRIVILEGES.php">
<input type="hidden" name="thisGRANTEEField" value="<? echo $thisGRANTEE; ?>">
<input type="submit" name="submitConfirmDeleteCOLUMN_PRIVILEGESForm" value="Delete  from COLUMN_PRIVILEGES">
