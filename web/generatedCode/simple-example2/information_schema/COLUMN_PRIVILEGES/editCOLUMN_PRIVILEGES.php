...
<h2>Update COLUMN_PRIVILEGES</h2>
<form name="column_privilegesUpdateForm" method="POST" action="updateColumn_privileges.php">
...
<input type="submit" name="submitUpdateCOLUMN_PRIVILEGESForm" value="Update COLUMN_PRIVILEGES">
