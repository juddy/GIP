...
?>
<?
$sql = "UPDATE INNODB_CMP_RESET SET page_size = '$thisPage_size' , compress_ops = '$thisCompress_ops' , compress_ops_ok = '$thisCompress_ops_ok' , compress_time = '$thisCompress_time' , uncompress_ops = '$thisUncompress_ops' , uncompress_time = '$thisUncompress_time'  WHERE page_size = '$thisPage_size'";
...
<br><br><a href="listINNODB_CMP_RESET.php">Go Back to List All Records</a>
