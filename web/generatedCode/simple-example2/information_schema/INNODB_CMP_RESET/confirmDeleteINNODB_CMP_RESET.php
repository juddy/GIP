...
<form name="innodb_cmp_resetEnterForm" method="POST" action="deleteINNODB_CMP_RESET.php">
<input type="hidden" name="thisPage_sizeField" value="<? echo $thisPage_size; ?>">
<input type="submit" name="submitConfirmDeleteINNODB_CMP_RESETForm" value="Delete  from INNODB_CMP_RESET">
