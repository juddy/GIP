...
?>
<?
$sqlQuery = "SELECT *  FROM INNODB_CMP_RESET WHERE page_size like '%$thisKeyword%'  OR compress_ops like '%$thisKeyword%'  OR compress_ops_ok like '%$thisKeyword%'  OR compress_time like '%$thisKeyword%'  OR uncompress_ops like '%$thisKeyword%'  OR uncompress_time like '%$thisKeyword%' ";
...
?>
	...
	<TD><a href="editINNODB_CMP_RESET.php?page_sizeField=<? echo $thisPage_size; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteINNODB_CMP_RESET.php?page_sizeField=<? echo $thisPage_size; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
