...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE INNODB_CMP_RESET SET page_size = '$thisPage_size' , compress_ops = '$thisCompress_ops' , compress_ops_ok = '$thisCompress_ops_ok' , compress_time = '$thisCompress_time' , uncompress_ops = '$thisUncompress_ops' , uncompress_time = '$thisUncompress_time'  WHERE page_size = '$thisPage_size'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO INNODB_CMP_RESET (page_size , compress_ops , compress_ops_ok , compress_time , uncompress_ops , uncompress_time ) VALUES ('$thisPage_size' , '$thisCompress_ops' , '$thisCompress_ops_ok' , '$thisCompress_time' , '$thisUncompress_ops' , '$thisUncompress_time' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM INNODB_CMP_RESET WHERE page_size = '$thisPage_size'";
...
$sql = "SELECT   * FROM INNODB_CMP_RESET".$orderByQuery.$limitQuery;
