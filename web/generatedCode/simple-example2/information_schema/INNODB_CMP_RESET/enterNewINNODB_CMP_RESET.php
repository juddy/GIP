...
?>
<h2>Enter INNODB_CMP_RESET</h2>
<form name="innodb_cmp_resetEnterForm" method="POST" action="insertNewInnodb_cmp_reset.php">
...
<input type="submit" name="submitEnterINNODB_CMP_RESETForm" value="Enter INNODB_CMP_RESET">
