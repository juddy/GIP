...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE SESSION_STATUS SET VARIABLE_NAME = '$thisVARIABLE_NAME' , VARIABLE_VALUE = '$thisVARIABLE_VALUE'  WHERE VARIABLE_NAME = '$thisVARIABLE_NAME'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO SESSION_STATUS (VARIABLE_NAME , VARIABLE_VALUE ) VALUES ('$thisVARIABLE_NAME' , '$thisVARIABLE_VALUE' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM SESSION_STATUS WHERE VARIABLE_NAME = '$thisVARIABLE_NAME'";
...
$sql = "SELECT   * FROM SESSION_STATUS".$orderByQuery.$limitQuery;
