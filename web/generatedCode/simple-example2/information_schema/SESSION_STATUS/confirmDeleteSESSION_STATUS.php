...
<form name="session_statusEnterForm" method="POST" action="deleteSESSION_STATUS.php">
<input type="hidden" name="thisVARIABLE_NAMEField" value="<? echo $thisVARIABLE_NAME; ?>">
<input type="submit" name="submitConfirmDeleteSESSION_STATUSForm" value="Delete  from SESSION_STATUS">
