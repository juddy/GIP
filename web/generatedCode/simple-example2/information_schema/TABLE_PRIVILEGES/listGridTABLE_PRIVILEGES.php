...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE TABLE_PRIVILEGES SET GRANTEE = '$thisGRANTEE' , TABLE_CATALOG = '$thisTABLE_CATALOG' , TABLE_SCHEMA = '$thisTABLE_SCHEMA' , TABLE_NAME = '$thisTABLE_NAME' , PRIVILEGE_TYPE = '$thisPRIVILEGE_TYPE' , IS_GRANTABLE = '$thisIS_GRANTABLE'  WHERE GRANTEE = '$thisGRANTEE'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO TABLE_PRIVILEGES (GRANTEE , TABLE_CATALOG , TABLE_SCHEMA , TABLE_NAME , PRIVILEGE_TYPE , IS_GRANTABLE ) VALUES ('$thisGRANTEE' , '$thisTABLE_CATALOG' , '$thisTABLE_SCHEMA' , '$thisTABLE_NAME' , '$thisPRIVILEGE_TYPE' , '$thisIS_GRANTABLE' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM TABLE_PRIVILEGES WHERE GRANTEE = '$thisGRANTEE'";
...
$sql = "SELECT   * FROM TABLE_PRIVILEGES".$orderByQuery.$limitQuery;
