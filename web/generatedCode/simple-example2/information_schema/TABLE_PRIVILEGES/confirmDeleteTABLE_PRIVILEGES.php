...
<form name="table_privilegesEnterForm" method="POST" action="deleteTABLE_PRIVILEGES.php">
<input type="hidden" name="thisGRANTEEField" value="<? echo $thisGRANTEE; ?>">
<input type="submit" name="submitConfirmDeleteTABLE_PRIVILEGESForm" value="Delete  from TABLE_PRIVILEGES">
