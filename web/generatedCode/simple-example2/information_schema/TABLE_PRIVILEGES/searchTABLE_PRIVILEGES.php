...
?>
<?
$sqlQuery = "SELECT *  FROM TABLE_PRIVILEGES WHERE GRANTEE like '%$thisKeyword%'  OR TABLE_CATALOG like '%$thisKeyword%'  OR TABLE_SCHEMA like '%$thisKeyword%'  OR TABLE_NAME like '%$thisKeyword%'  OR PRIVILEGE_TYPE like '%$thisKeyword%'  OR IS_GRANTABLE like '%$thisKeyword%' ";
...
?>
	...
	<TD><a href="editTABLE_PRIVILEGES.php?GRANTEEField=<? echo $thisGRANTEE; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteTABLE_PRIVILEGES.php?GRANTEEField=<? echo $thisGRANTEE; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
