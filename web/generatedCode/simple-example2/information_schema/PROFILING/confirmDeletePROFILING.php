...
<form name="profilingEnterForm" method="POST" action="deletePROFILING.php">
<input type="hidden" name="thisQUERY_IDField" value="<? echo $thisQUERY_ID; ?>">
<input type="submit" name="submitConfirmDeletePROFILINGForm" value="Delete  from PROFILING">
