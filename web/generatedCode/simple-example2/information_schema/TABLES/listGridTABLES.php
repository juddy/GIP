...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM TABLES WHERE TABLE_CATALOG = '$thisTABLE_CATALOG'";
...
$sql = "SELECT   * FROM TABLES".$orderByQuery.$limitQuery;
...
<input type="hidden" name="thisTABLE_CATALOGField" value="<? echo $thisTABLE_CATALOG; ?>">
	<TR BGCOLOR="#FF6666">
		...
		<TD><input type"text" name="thisTABLE_TYPEField" value=""></TD>
		...
		<TD><input type"text" name="thisAUTO_INCREMENTField" value=""></TD>
		...
		<TD><input type"text" name="thisTABLE_COLLATIONField" value=""></TD>
		<TD><input type"text" name="thisCHECKSUMField" value=""></TD>
		<TD><input type"text" name="thisCREATE_OPTIONSField" value=""></TD>
		<TD><input type"text" name="thisTABLE_COMMENTField" value=""></TD>
...
<input type="hidden" name="thisTABLE_CATALOGField" value="<? echo $thisTABLE_CATALOG; ?>">
	<TR BGCOLOR="<? echo $bgColor; ?>">
		...
		<TD><input type"text" name="thisTABLE_TYPEField" value="<? echo $thisTABLE_TYPE; ?>"></TD>
		...
		<TD><input type"text" name="thisAUTO_INCREMENTField" value="<? echo $thisAUTO_INCREMENT; ?>"></TD>
		...
		<TD><input type"text" name="thisTABLE_COLLATIONField" value="<? echo $thisTABLE_COLLATION; ?>"></TD>
		<TD><input type"text" name="thisCHECKSUMField" value="<? echo $thisCHECKSUM; ?>"></TD>
		<TD><input type"text" name="thisCREATE_OPTIONSField" value="<? echo $thisCREATE_OPTIONS; ?>"></TD>
		<TD><input type"text" name="thisTABLE_COMMENTField" value="<? echo $thisTABLE_COMMENT; ?>"></TD>
