...
<form name="statisticsEnterForm" method="POST" action="deleteSTATISTICS.php">
<input type="hidden" name="thisTABLE_CATALOGField" value="<? echo $thisTABLE_CATALOG; ?>">
<input type="submit" name="submitConfirmDeleteSTATISTICSForm" value="Delete  from STATISTICS">
