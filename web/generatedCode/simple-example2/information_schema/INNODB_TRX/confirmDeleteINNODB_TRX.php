...
<form name="innodb_trxEnterForm" method="POST" action="deleteINNODB_TRX.php">
<input type="hidden" name="thisTrx_idField" value="<? echo $thisTrx_id; ?>">
<input type="submit" name="submitConfirmDeleteINNODB_TRXForm" value="Delete  from INNODB_TRX">
