...
?>
	...
	<TD><a href="editCMS_OFFLINE_STRUCTURE.php?STRUCTURE_IDField=<? echo $thisSTRUCTURE_ID; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteCMS_OFFLINE_STRUCTURE.php?STRUCTURE_IDField=<? echo $thisSTRUCTURE_ID; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
