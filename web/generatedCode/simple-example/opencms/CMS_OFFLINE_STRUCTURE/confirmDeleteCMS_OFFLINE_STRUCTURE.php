...
<form name="cms_offline_structureEnterForm" method="POST" action="deleteCMS_OFFLINE_STRUCTURE.php">
<input type="hidden" name="thisSTRUCTURE_IDField" value="<? echo $thisSTRUCTURE_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_OFFLINE_STRUCTUREForm" value="Delete  from CMS_OFFLINE_STRUCTURE">
