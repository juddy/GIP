...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM CMS_OFFLINE_STRUCTURE WHERE STRUCTURE_ID = '$thisSTRUCTURE_ID'";
...
$sql = "SELECT   * FROM CMS_OFFLINE_STRUCTURE".$orderByQuery.$limitQuery;
