...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE CMS_OFFLINE_PROPERTYDEF SET PROPERTYDEF_ID = '$thisPROPERTYDEF_ID' , PROPERTYDEF_NAME = '$thisPROPERTYDEF_NAME' , PROPERTYDEF_TYPE = '$thisPROPERTYDEF_TYPE'  WHERE PROPERTYDEF_ID = '$thisPROPERTYDEF_ID'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO CMS_OFFLINE_PROPERTYDEF (PROPERTYDEF_ID , PROPERTYDEF_NAME , PROPERTYDEF_TYPE ) VALUES ('$thisPROPERTYDEF_ID' , '$thisPROPERTYDEF_NAME' , '$thisPROPERTYDEF_TYPE' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM CMS_OFFLINE_PROPERTYDEF WHERE PROPERTYDEF_ID = '$thisPROPERTYDEF_ID'";
...
$sql = "SELECT   * FROM CMS_OFFLINE_PROPERTYDEF".$orderByQuery.$limitQuery;
