...
<form name="cms_offline_propertydefEnterForm" method="POST" action="deleteCMS_OFFLINE_PROPERTYDEF.php">
<input type="hidden" name="thisPROPERTYDEF_IDField" value="<? echo $thisPROPERTYDEF_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_OFFLINE_PROPERTYDEFForm" value="Delete  from CMS_OFFLINE_PROPERTYDEF">
