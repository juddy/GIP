...
?>
<?
$sql = "UPDATE CMS_OFFLINE_PROPERTYDEF SET PROPERTYDEF_ID = '$thisPROPERTYDEF_ID' , PROPERTYDEF_NAME = '$thisPROPERTYDEF_NAME' , PROPERTYDEF_TYPE = '$thisPROPERTYDEF_TYPE'  WHERE PROPERTYDEF_ID = '$thisPROPERTYDEF_ID'";
...
<br><br><a href="listCMS_OFFLINE_PROPERTYDEF.php">Go Back to List All Records</a>
