...
<form name="cms_online_propertiesEnterForm" method="POST" action="deleteCMS_ONLINE_PROPERTIES.php">
<input type="hidden" name="thisPROPERTY_IDField" value="<? echo $thisPROPERTY_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_ONLINE_PROPERTIESForm" value="Delete  from CMS_ONLINE_PROPERTIES">
