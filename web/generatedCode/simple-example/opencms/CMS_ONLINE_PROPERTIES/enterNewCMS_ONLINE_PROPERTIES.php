...
?>
<h2>Enter CMS_ONLINE_PROPERTIES</h2>
<form name="cms_online_propertiesEnterForm" method="POST" action="insertNewCms_online_properties.php">
...
<input type="submit" name="submitEnterCMS_ONLINE_PROPERTIESForm" value="Enter CMS_ONLINE_PROPERTIES">
