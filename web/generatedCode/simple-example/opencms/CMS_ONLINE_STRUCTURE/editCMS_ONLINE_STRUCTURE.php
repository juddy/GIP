...
<h2>Update CMS_ONLINE_STRUCTURE</h2>
<form name="cms_online_structureUpdateForm" method="POST" action="updateCms_online_structure.php">
...
<input type="submit" name="submitUpdateCMS_ONLINE_STRUCTUREForm" value="Update CMS_ONLINE_STRUCTURE">
