...
?>
<?
$sqlQuery = "SELECT *  FROM CMS_OFFLINE_URLNAME_MAPPINGS WHERE NAME like '%$thisKeyword%'  OR STRUCTURE_ID like '%$thisKeyword%'  OR STATE like '%$thisKeyword%'  OR DATE_CHANGED like '%$thisKeyword%'  OR LOCALE like '%$thisKeyword%' ";
...
?>
	...
	<TD><a href="editCMS_OFFLINE_URLNAME_MAPPINGS.php?NAMEField=<? echo $thisNAME; ?>">Edit</a></TD>
	<TD><a href="confirmDeleteCMS_OFFLINE_URLNAME_MAPPINGS.php?NAMEField=<? echo $thisNAME; ?>">Delete</a></TD>
	</TR>
<?
		$i++;
