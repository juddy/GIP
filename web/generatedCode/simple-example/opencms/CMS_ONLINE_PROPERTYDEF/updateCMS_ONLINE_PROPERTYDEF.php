...
?>
<?
$sql = "UPDATE CMS_ONLINE_PROPERTYDEF SET PROPERTYDEF_ID = '$thisPROPERTYDEF_ID' , PROPERTYDEF_NAME = '$thisPROPERTYDEF_NAME' , PROPERTYDEF_TYPE = '$thisPROPERTYDEF_TYPE'  WHERE PROPERTYDEF_ID = '$thisPROPERTYDEF_ID'";
...
<br><br><a href="listCMS_ONLINE_PROPERTYDEF.php">Go Back to List All Records</a>
