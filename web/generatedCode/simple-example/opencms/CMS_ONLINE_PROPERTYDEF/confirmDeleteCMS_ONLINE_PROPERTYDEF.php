...
<form name="cms_online_propertydefEnterForm" method="POST" action="deleteCMS_ONLINE_PROPERTYDEF.php">
<input type="hidden" name="thisPROPERTYDEF_IDField" value="<? echo $thisPROPERTYDEF_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_ONLINE_PROPERTYDEFForm" value="Delete  from CMS_ONLINE_PROPERTYDEF">
