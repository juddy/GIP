...
<form name="cms_history_resourcesEnterForm" method="POST" action="deleteCMS_HISTORY_RESOURCES.php">
<input type="hidden" name="thisRESOURCE_IDField" value="<? echo $thisRESOURCE_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_HISTORY_RESOURCESForm" value="Delete  from CMS_HISTORY_RESOURCES">
