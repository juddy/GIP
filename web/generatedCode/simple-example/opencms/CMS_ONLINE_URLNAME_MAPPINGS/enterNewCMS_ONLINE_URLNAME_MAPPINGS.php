...
?>
<h2>Enter CMS_ONLINE_URLNAME_MAPPINGS</h2>
<form name="cms_online_urlname_mappingsEnterForm" method="POST" action="insertNewCms_online_urlname_mappings.php">
...
<input type="submit" name="submitEnterCMS_ONLINE_URLNAME_MAPPINGSForm" value="Enter CMS_ONLINE_URLNAME_MAPPINGS">
