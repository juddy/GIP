...
<form name="cms_online_resource_relationsEnterForm" method="POST" action="deleteCMS_ONLINE_RESOURCE_RELATIONS.php">
<input type="hidden" name="thisRELATION_SOURCE_IDField" value="<? echo $thisRELATION_SOURCE_ID; ?>">
<input type="submit" name="submitConfirmDeleteCMS_ONLINE_RESOURCE_RELATIONSForm" value="Delete  from CMS_ONLINE_RESOURCE_RELATIONS">
