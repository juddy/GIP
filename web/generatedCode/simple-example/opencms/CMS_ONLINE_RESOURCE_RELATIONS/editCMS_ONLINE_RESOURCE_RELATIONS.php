...
?>
<?php
$sql = "SELECT   * FROM CMS_ONLINE_RESOURCE_RELATIONS WHERE RELATION_SOURCE_ID = '$thisRELATION_SOURCE_ID'";
...
<h2>Update CMS_ONLINE_RESOURCE_RELATIONS</h2>
<form name="cms_online_resource_relationsUpdateForm" method="POST" action="updateCms_online_resource_relations.php">
...
<input type="submit" name="submitUpdateCMS_ONLINE_RESOURCE_RELATIONSForm" value="Update CMS_ONLINE_RESOURCE_RELATIONS">
