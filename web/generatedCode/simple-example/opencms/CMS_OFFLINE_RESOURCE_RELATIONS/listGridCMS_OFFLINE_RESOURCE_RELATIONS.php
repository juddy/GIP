...
if ($thisAction=="Update")
{
	...
	$sqlUpdate = "UPDATE CMS_OFFLINE_RESOURCE_RELATIONS SET RELATION_SOURCE_ID = '$thisRELATION_SOURCE_ID' , RELATION_SOURCE_PATH = '$thisRELATION_SOURCE_PATH' , RELATION_TARGET_ID = '$thisRELATION_TARGET_ID' , RELATION_TARGET_PATH = '$thisRELATION_TARGET_PATH' , RELATION_TYPE = '$thisRELATION_TYPE'  WHERE RELATION_SOURCE_ID = '$thisRELATION_SOURCE_ID'";
...
if ($thisAction=="Insert")
{
	...
	$sqlInsert = "INSERT INTO CMS_OFFLINE_RESOURCE_RELATIONS (RELATION_SOURCE_ID , RELATION_SOURCE_PATH , RELATION_TARGET_ID , RELATION_TARGET_PATH , RELATION_TYPE ) VALUES ('$thisRELATION_SOURCE_ID' , '$thisRELATION_SOURCE_PATH' , '$thisRELATION_TARGET_ID' , '$thisRELATION_TARGET_PATH' , '$thisRELATION_TYPE' )";
...
if ($thisAction=="Delete")
{
	...
	$sqlDelete = "DELETE FROM CMS_OFFLINE_RESOURCE_RELATIONS WHERE RELATION_SOURCE_ID = '$thisRELATION_SOURCE_ID'";
