...
include_once(CLASS_SQL_ENGINE_CREATE_GENERATOR);
?>
<? 
class SQLCreateGenerator extends commonSqlGenerator 
{
	
	function SQLCreateGenerator($arguments)
	{
		$db = $arguments['db'];
	...
	function generate()
	{
		...
		$thisSqlEngine = new  createSQLGenerator($thisTable->getTableName(),$thisTable->getDatabase());
