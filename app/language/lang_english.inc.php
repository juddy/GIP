...
define("LANG_DESC_WHAT_IS_IT","Given any database schema, tables within, list of fields and properties, one ought to be able to build any kind of database backed applications in any programming language. The basic operations that a database backed application will have are usually the same - Create Records, Retreive Records, Update Records, Delete Records (CRUD). <br><br> phpCodeGenie attempts to generate these CRUD code so that programmers have a base they can work on. The core database access code and scripts are usually the same for most applications. Rather than spending a lot of time doing these common code, we can spend our time on the business logic of our applications and let PCG do the boring code for you. phpCodeGenie can generate simple code for beginners where everything is done in the same PHP script or structure Object Oriented PHP Code that follows the PCG framework. <br><br> phpCodeGenie requires you to design your tables and then the genie can generate code for reading and writing to the database, the html forms to enter or edit data in the database, scripts to list data, scripts to delete data, search forms, search scripts among others.<br><br>phpCodeGenie was designed with the novice user in mind as well as the experienced PHP programmer wanting to build a complex application.");

define("LANG_DESC_INSTRUCTIONS","Please choose a Database and a Table from the left and I will start coding for you master.. ");

define("LANG_DESC_PROJECT_PAGE","Project Page");
define("LANG_DESC_DONATE_TO_PROJECT","Donate to this Project");
define("LANG_DESC_HAVING_PROBLEMS","Having technical problems with PCG? Get Help here ! ");
define("LANG_DESC_SUBMIT_BUG","Found a Bug in PCG? Submit it here !");
define("LANG_DESC_SUBMIT_DOCUMENTATION","Wrote a piece of Documentation for PCG? Submit it here");
define("LANG_DESC_GIVE_FEEDBACK","Give us your feedback on phpCodeGenie");

define("LANG_LOGIN_INVOKE_GENIE","Invoke the phpCodeGenie from the LAMP");
define("LANG_LOGIN_GENIE_FLAVOR","Genie Flavor");
define("LANG_LOGIN_DB_HOSTNAME","Datatabase HostName (Ip or Host)");
define("LANG_LOGIN_DB_USER_NAME","Database Username");
define("LANG_LOGIN_DB_PASSWORD","Database Password");
define("LANG_LOGIN_RUB_LAMP","Rub the LAMP to wake up the phpCodeGenie...");
define("LANG_LOGIN_RUB_LAMP_DESC","Fill in the form above and click me and I'll come out of the LAMP");
...
define("LANG_GEN_CHOOSER_USER_PLUGIN_GENERATOR","PCG User Plug Ins");
define("LANG_GEN_CHOOSER_UTILS_GENERATOR","Utilities");

define("LANG_SG_SIMPLE_GENERATOR","Simple PHP Code Generator");
define("LANG_SG_SIMPLE_GENERATOR_DESC","This generator generates simple php code to access a database and do the basic operations on it. I would not encourage you to write production level applications using this code. Use the code from the Advanced Generator rather for production applications.");
...
define("LANG_AG_ADVANCED_GENERATOR_DIAGRAM","PCG Framework in a NutShell Diagram");
...
define("LANG_SIMPLE_GENERATE_ALL_CODE_LINK","Generate ALL Code for  Entire Database Application and Save to Disk ");
...
define("LANG_PCG_PLUGIN_SCAN_PLUGINS","SCAN FOR PCG PLUGINS ");
...
define("LANG_UTILITIES_LANG_FILE_BUILDER","PCG NEW Language File Builder ");
define("LANG_UTILITIES_LANG_FILE_BUILDER_DESC","This tool provides you with an easy interface to build a new language file for PCG.");
...
define("LANG_UPLUGINS_LEARN_HOW_TO_WRITE_YOUR_OWN_PGIN","Learn how to write your own PCG Plugin");
