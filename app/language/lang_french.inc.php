...
define("LANG_DESC_WHAT_IS_IT", " Donné n'importe quel schéma, tables en dedans, liste de champs et propriétés de base de données, on doit pouvoir établir n'importe quel genre d'applications soutenues par base de données en n'importe quel langage de programmation. Les opérations de base qu'une application soutenue par base de données aura sont habituellement identique - créez les disques, disques de Retreive, disques de mise à jour, les disques d'effacement (CRUD). le gip essaye de produire du code de ces CRUD de sorte que les programmeurs aient une base qu'ils peuvent fonctionner dessus. Le code et les manuscrits d'accès aux bases de données de noyau sont habituellement le même pour la plupart des applications. Plutôt que faire beaucoup de temps de dépense ces code commun, nous pouvons passer notre temps sur la logique d'affaires de nos applications et laissez GIP font le code ennuyeux pour que vous le gip peut produire du code simple pour des débutants où tout est fait dans le même code orienté par objet de manuscrit ou de structure PHP de PHP qui suit le cadre de GIP. le gip exige de vous de concevoir vos tables et alors le gip peut produire du code pour la lecture et l'écriture à la base de données, les formes de HTML pour saisir ou éditer des données dans la base de données, manuscrits pour énumérer des données, manuscrits pour supprimer des données, les formes de recherche, manuscrits de recherche entre d'autres gip a été conçue avec l'utilisateur de débutant à l'esprit aussi bien que le programmeur expérimenté de PHP voulant établir une application complexe. "); 
...
define("LANG_LOGIN_INVOKE_GENIE", "Appelez le gip de la LAMPe "); 
...
define("LANG_LOGIN_RUB_LAMP", "Frottez la LAMPe pour réveiller le gip... "); 
...
define("LANG_UP_USER_PLUGINS_DESC", " le gip vous permet d'écrire votre propre générateur plugin et de le laisser tomber dedans ici. Lisez les Doc.s sur des caractéristiques d'un GIP plugin et après que vous écriviez votre plugin, juste les laissent tomber dans les userPlugIns que l'annuaire pour eux à révèlent ici. "); 
...
define("LANG_ADVANCED_GENERATE_ALL_CODE_LINK", " Produisez de tout le code de CRUD pour toutes les tables de cette base de données pour le cadre de GIP et l'économisez au  de disque "); 

define("LANG_GIP_PLUGIN_SCAN_PLUGINS", " Balayage pour le  de Plugins "); 
define("LANG_GIP_PLUGIN_SCAN_PLUGINS_DESC", " Cet outil balayera dans l'annuaire plugin pour tout le GIP Plugins et vous permettra de les courir. "); 
...
define("LANG_UTILITIES_GENERATE_GENERATOR_DESC", " Établit le code pour une classe plugin de gip pour vous. Cette utilité convertit le texte ou vous code veulent se produire au code produit par GIP. Lisez le cours d'instruction sur le développement plugin de GIP pour savoir plus. "); 
...
define("LANG_UTILITIES_GEN_GENERATOR_TEXT1", " Son facile d'établir une génération de code plugin pour le gip. Fondamentalement la génération de code est tout au sujet de la modification de chaîne de caractères. Vous voulez traiter une certaine entrée d'une manière quelconque et la produire a enfoncé dans un autre morceau de corde. "); 
define("LANG_UTILITIES_GEN_GENERATOR_TEXT2", " Ce 'Generate un Generator' ; l'outil établira une classe plugin squelettique du code GIP que vous pouvez facilement modifier pour produire de votre code. Par exemple si vous avez un HTML page ou un certain morceau de code en toute langue que vous voulez que GIP se produise, la pâte juste le contenu entier de page dans la boîte des textes ci-dessous et le clic se produisent et vous aurez une classe plugin squelettique de base que vous pouvez travailler dessus. "); 
...
define("LANG_AGEN_PAGE_CONSTANTS_GENERATOR_DESC", " Chaque des pages que l'application de GIP aura est définies dedans ici avec la pleine adresse URL. "); 
define("LANG_AGEN_DB_CONSTANTS_GENERATOR", "Constantes de Base de données "); 
define("LANG_AGEN_DB_CONSTANTS_GENERATOR_DESC", " Chaque Tableau et champs étant miss en référence dans une application de GIP est défini en ce code. Il est tracé aux constantes que nous employons dans l'application de GIP. "); 
...
define("LANG_GALL_ADV_HEADER",  " Le Cadre de GIP Produisent De Tout le  De Code "); 
