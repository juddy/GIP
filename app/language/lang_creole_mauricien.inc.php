...
define("LANG_BASIC_DATABASES","Base de Données");
define("LANG_BASIC_DATABASE","Base de Donnée");
define("LANG_BASIC_ACTIVE","Actif");
define("LANG_BASIC_TABLE","La Table");
define("LANG_BASIC_LICENSE","License");
define("LANG_BASIC_INSTALL","Install Sa");
define("LANG_BASIC_README","Lire Moi");
define("LANG_BASIC_DOWNLOAD","Load Li");
define("LANG_BASIC_BY","par");
define("LANG_BASIC_DATABASE_TYPE","Type de Base de Donnée");
define("LANG_BASIC_USER","Itilizater");
define("LANG_BASIC_GENERATOR","Zenerateur");
define("LANG_BASIC_GENERATE","Zenere");
define("LANG_BASIC_TYPE","Type");
define("LANG_BASIC_ERROR","Errer");
define("LANG_BASIC_HEADER","La Haut Page :");
define("LANG_BASIC_FOOTER","En Bas Page :");
define("LANG_BASIC_LANGUAGE","Languaze");
define("LANG_BASIC_PATH","Chimain");
define("LANG_BASIC_LOGOUT","Deconnecter");
define("LANG_BASIC_CHOSEN","Seki oune choisir");
define("LANG_BASIC_INTRODUCTION","Introdiction");
define("LANG_BASIC_NONE_SELECTED","Aukene panne choisir");
define("LANG_BASIC_ENTER","Azoute");
define("LANG_BASIC_EDIT","Corrize");
define("LANG_BASIC_INSERT","Mette li");
define("LANG_BASIC_UPDATE","Corrize");
define("LANG_BASIC_LIST","Faire ene La Liste");
define("LANG_BASIC_DELETE","Efface Sa");
define("LANG_BASIC_GO_BACK","Retourne Derriere");
define("LANG_BASIC_KEYWORD","Ene Mot Cle");



define("LANG_BASIC_CLEAR_FORM","Efface Forme La");
define("LANG_BASIC_FROM"," depi ");


define("LANG_DESC_WHAT_IS_IT","Si ou ena ene database et tout banne table ki la dans, ou bizin capav ranze ene application ki fonctionne lors internet sans aukene probleme.En commencant n'importe quel schéma de base de données, tables en dedans, liste de champs et les propriétés, une doivent pouvoir établir n'importe quel genre d'applications soutenues par base de données en n'importe quel langage de programmation. Les opérations de base qu'une application soutenue par base de données aura sont habituellement identique - créez les disques, disques de Retreive, disques de mise à jour, les disques d'effacement (CRUD). le phpCodeGenie essaye de produire du code de ces CRUD de sorte que les programmeurs aient une base qu'ils peuvent fonctionner dessus. Le code et les manuscrits d'accès aux bases de données de noyau sont habituellement le même pour la plupart des applications. Plutôt que faire beaucoup de temps de dépense ces code commun, nous pouvons passer notre temps sur la logique d'affaires de nos applications et laissez PCG font le code ennuyeux pour que vous le phpCodeGenie peut produire du code simple pour des débutants où tout est fait dans le même code orienté par objet de manuscrit ou de structure PHP de PHP qui suit le cadre de PCG. le phpCodeGenie exige de vous de concevoir vos tables et alors le genie peut produire du code pour la lecture et l'écriture à la base de données, les formes de HTML pour saisir ou éditer des données dans la base de données, manuscrits pour énumérer des données, manuscrits pour supprimer des données, les formes de recherche, manuscrits de recherche entre d'autres phpCodeGenie a été conçue avec l'utilisateur de débutant à l'esprit aussi bien que le programmeur expérimenté de PHP voulant établir une application complexe.");

define("LANG_DESC_INSTRUCTIONS","Veuillez choisir une base de données et un Tableau à partir de la gauche et de moi commencera le codage pour vous maître... ");


define("LANG_LOGIN_INVOKE_GENIE","Invoke phpCodeGenie depi la LAMPe");
define("LANG_LOGIN_GENIE_FLAVOR","Ki Genie ou Le ");
define("LANG_LOGIN_DB_HOSTNAME","Laddresse ou baze de donnee");
define("LANG_LOGIN_DB_USER_NAME","Compte seki ou ena lors baze de donnee");
define("LANG_LOGIN_DB_PASSWORD","Password seki ou servi lors baze de donnee");
define("LANG_LOGIN_RUB_LAMP","Frotte Frotte la LAMPe la pou faire phpCodeGenie sorti...");
define("LANG_LOGIN_RUB_LAMP_DESC","Complétez la forme ci-dessus et cliquez-moi et je sortirais de la LAMPe");




define("LANG_GEN_CHOOSER_BEGINNING_PROGRAMMERS","Programeur Amater");
define("LANG_GEN_CHOOSER_ADVANCED_PROGRAMMERS","Programeur Experiences");
define("LANG_GEN_CHOOSER_FULLAPP_GENERATOR","Full Application Generation");
define("LANG_GEN_CHOOSER_USER_PLUGIN_GENERATOR","Plug Ins depi Utilizateurs");
define("LANG_GEN_CHOOSER_UTILS_GENERATOR","Utilités");

define("LANG_SG_SIMPLE_GENERATOR","Générateur de Code PHP Simple");
...
define("LANG_AG_ADVANCED_GENERATOR_DESC","The advanced generator generates code for the PCG Framework. The PCG framework maps every table to a class with getters and setters on each field. These classes are just containers. They do not contain logic. There are DAO Classes which deal with all the CRUD operation on these container classes. The front end of your applicaitons access the DAO Classes through Delegate Classes with interact with the DAO. That's the PCG Framework in a nutshell, but there's a lot more to it. Read the documentation to find out more.");
...
define("LANG_UP_USER_PLUGINS_DESC","phpCodeGenie allows you to write your own generator plugin and drop it in here. Read the docs on specifications of a PCG plugin and after you write your plugin, just drop them in the userPlugIns directory for them to show up here.");
...
define("LANG_SIMPLE_NO_TABLE_SELECTED","No Table Selected. Please choose a table from the left side panel for individual code Generation. If you want to generate all CRUD Code for this table, click on the link below.");
define("LANG_SIMPLE_GENERATE_ALL_CODE_LINK","Generate All CRUD Code for all tables from this Database and Save to Disk ");

define("LANG_SIMPLE_FORM_MAKER","Code Genie Form Maker  ");
...
define("LANG_ADVANCED_GENERATE_ALL_CODE_LINK","Generate All CRUD Code for all tables from this Database for PCG Framework and Save to Disk ");



// PCG PLUGINS MAIN PAGE
define("LANG_PCG_PLUGIN_SCAN_PLUGINS","Scan for Plugins ");
define("LANG_PCG_PLUGIN_SCAN_PLUGINS_DESC","This tool will scan in the plugin Directory for all PCG Plugins and allow you to run them.");
...
define("LANG_UTILITIES_GENERATE_GENERATOR_DESC","Builds the code for a phpCodeGenie plugin class for you. This utility converts the text or code you want to generate to PCG generated code. Read the tutorial on PCG Plugin Development to know more.  ");
...
define("LANG_UTILITIES_SQL_GENERATOR_DESC","This tool generares sample SELECT, UPDATE, INSERT, DELETE, CREATE SQL statements from the fields in your chosen table. It also create insert dumps of data actually in your database. Useful for backups or recreating a table.  ");
...
define("LANG_UTILITIES_GEN_GENERATOR_TEXT1","Its easy to build a code generation plugin for phpCodeGenie. Basically Code Generation is all about string manipulation. You want to process some input in some way and output it embedded in another piece of String.");
define("LANG_UTILITIES_GEN_GENERATOR_TEXT2","This 'Generate a Generator' tool will build a skeleton code PCG plugin class that you can easily modify to generate your code. For example if you have an html page or some piece of code in any language that you want PCG to generate, just paste the entire page contents in the text box below and click generate and you will have a basic skeleton plugin class you can work on. ");
...
define("LANG_AGEN_PAGE_CONSTANTS_GENERATOR_DESC","Every pages that the PCG application will have is defined in here with full URL Address. ");

define("LANG_AGEN_DB_CONSTANTS_GENERATOR","Database Constants");
define("LANG_AGEN_DB_CONSTANTS_GENERATOR_DESC","Every Table and Fields being referenced in a PCG application is defined in this Code. They are mapped to constants that we use in the PCG application.");
...
define("LANG_AGEN_WEB_GEN_INSERT_SCRIPT","Generate Insert Script (Genie Framework) ");
define("LANG_AGEN_WEB_GEN_INSERT_SCRIPT_DESC","");

define("LANG_AGEN_WEB_GEN_EDIT_FORM","Generate Edit Form (Genie Framework) ");
define("LANG_AGEN_WEB_GEN_EDIT_FORM_DESC","");

define("LANG_AGEN_WEB_GEN_UPDATE_SCRIPT","Generate Update Script (Genie Framework) ");
...
define("LANG_GALL_ADV_HEADER","PCG Framework Generate All Code");
